...
.AddJwtBearer(options =>
{
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        ClockSkew = TimeSpan.Zero,        // Onemogucava vremensku toleranciju pri validaciji tokena, pa token postaje nevazeci tacno u trenutku isteka ili pre vremena vazenja 
